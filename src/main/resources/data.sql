...
insert into ads (title, price, horse_power, sell_or_search, year_of_manufact, category_id)
values ('Ad1', 20, 150, true, 1980, 1);
insert into ads (title, price, horse_power, sell_or_search, year_of_manufact, category_id)
values ('Ad2', 30, 3, false, 2019, 2);
insert into ads (title, price, horse_power, sell_or_search, year_of_manufact, category_id)
values ('Ad2', 220, 1150, true, 1994, 3);