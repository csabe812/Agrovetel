...
insert into ads (title, price, horse_power, sell_or_search, year_of_manufact, category_id, user_id, county_id)
values ('Ad1', 20, 150, true, 1980, 1, 1, 1);
insert into ads (title, price, horse_power, sell_or_search, year_of_manufact, category_id, user_id, county_id)
values ('Ad2', 25, 150, true, 1980, 1, 2, 1);
insert into ads (title, price, horse_power, sell_or_search, year_of_manufact, category_id, user_id, county_id)
values ('Ad3', 35, 150, true, 1980, 1, 2, 1);
insert into ads (title, price, horse_power, sell_or_search, year_of_manufact, category_id, user_id, county_id)
values ('Ad4', 30, 3, false, 2019, 2, 3, 2);
insert into ads (title, price, horse_power, sell_or_search, year_of_manufact, category_id, user_id, county_id)
values ('Ad5', 220, 1150, true, 1994, 3, 3, 3);